...
do
    ...
    python3 main.py --input "bases_grafos/entrada1.txt" --elitism $True --id "elitism-True-entrada1-$counter" > logs/results-elitism-entrada1-elitism-True-$counter-run.log
    
    echo "Running exp on elitism: False || Counter: $counter"
    python3 main.py --input "bases_grafos/entrada1.txt" --elitism $False --id "elitism-False-entrada1-$counter" > logs/results-elitism-entrada1-elitism-False-$counter-run.log
